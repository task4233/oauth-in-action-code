...
app.post('/register', function (req, res){
	...
	// confirm auth_method which is only allowed client_secret_basic, client_secret_post, and 'none'.
	...
	// confirm grant_types and response_types pairs
	...
	// if grant_types don't contain both 'authorization_code' and 'refresh_token' or 'code' as response_types,
	// the authorization server denies the given dynamic client regsitration request.
